        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start lg:space-x-8 mb-4">
          ...
          <div className="lg:w-1/2">
            <p className="text-center lg:text-left mb-4">
              ...
              At [Your Company Name], we specialize in providing top-notch OS
              installation services to ensure your system runs smoothly and
              efficiently. But that’s not all! We offer a wide range of
              additional services to meet all your tech needs. Explore our
              offerings below: world.
            </p>
            <h2>
